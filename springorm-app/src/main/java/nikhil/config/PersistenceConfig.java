...
public class PersistenceConfig {
	...
	public DataSource dataSource() {
		String location = "D:\\java files\\MySpringBootProjects\\springorm-app\\src\\main\\resources\\application.properties";
	...
	public LocalSessionFactoryBean sessionFactory(DataSource dataSource) {
		...
		sessionFactory.setPackagesToScan("nikhil.beans");
